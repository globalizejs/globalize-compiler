...
function compileExtracts( attributes ) {
	var cldr, cldrObject, defaultLocale, extracts, formattersAndParsers, ianaTimeZoneData, messages, messagesObject;
	...
	ianaTimeZoneData = attributes.ianaTimeZoneData || function() {
